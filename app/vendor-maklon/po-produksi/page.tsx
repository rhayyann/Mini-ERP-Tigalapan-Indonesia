...
import { addDays, formatDate, formatPcs, formatRupiah, maklonPoBadge, maklonPoDisplayStatus, materialReceivedForMaklon, mrpDetailFor } from "@/lib/mrp/derive";
    ...
    >
      <DataTable
        ...
        filterDefs={[
          ...
          {
            label: "Status",
            options: Array.from(new Set(myPOs.map((p) => maklonPoBadge({ ...p, status: maklonPoDisplayStatus(p, vendorInvoices) }).label))),
